...
conf_to_print = {}
static_param = ['client', 'nobind', 'persist-key', 'persist-tun', 'verb 2', 'ns-cert-type server', 'comp-lzo']
auth_type_human_readable = {'psk':'PSK','cert':'Certificate','psk_cert':'Certificate & PSK'}
